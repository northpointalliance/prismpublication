...
const _envPaypalClientId: string = process.env.PAYPAL_CLIENT_ID || "";
const _envPaypalClientSecret: string = process.env.PAYPAL_CLIENT_SECRET || "";
const _envPaypalMode: "live" | "sandbox" = process.env.PAYPAL_MODE === "live" ? "live" : "sandbox";
